...
def extract_tasks(description):
    """Extracts markdown-style tasks from description."""
    tasks = []
    if not description:
        return tasks

    # Regex for markdown-style tasks: - [ ] or - [x]
    # Matches lines containing the task pattern.
    ...
    for filepath in ics_files:
        ...
        for component in cal.walk():
            if component.name == "VEVENT":
                ...
                event['tasks'] = extract_tasks(description)
